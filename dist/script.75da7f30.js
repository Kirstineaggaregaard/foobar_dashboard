...
var endpoint = "https://kirchris.herokuapp.com/";
var URL = "https://kirchris.herokuapp.com/";
var people = document.querySelector(".people");
var intervalId; // const data = {
...
function get() {
  fetch(endpoint, {
    ...
    return e.json();
  }).then(showData); //do stuff with the data
}
...
function showData(data) {
  ...
  var temp = document.querySelector(".template_serving");
  var dest2 = document.querySelector("#liste2");
  var temp2 = document.querySelector(".template_prepared");
  var dest3 = document.querySelector("#liste3");
  var temp3 = document.querySelector(".template_bartenders");
  var pep = data.queue;
  var tenders = data.bartenders;
  dest.textContent = "";
  dest2.textContent = "";
  dest3.textContent = "";
  var numbers = data.serving;
  console.log("wanna show");
  document.querySelector(".people").textContent = data.queue.length; //   dest.textContent = "";
  ...
  tenders.forEach(function (tender) {
    var klon = temp3.cloneNode(true).content;
  ...
  pep.forEach(function (number) {
    var klon = temp2.cloneNode(true).content;
